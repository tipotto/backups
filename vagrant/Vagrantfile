...
Vagrant.configure("2") do |config|
  ...
  # Customize the amount of storage on the VM:
  ...
  config.vm.provider "virtualbox" do |vb|
    ...
    vb.customize [
      ...
      "--paravirtprovider", "kvm", # 準仮想化インターフェイス      
      "--hwvirtex", "on", # VT-x/AMDVを有効化
      #"--nested-hw-virt", "on", # ネステッドVT-x/AMDVを有効化
